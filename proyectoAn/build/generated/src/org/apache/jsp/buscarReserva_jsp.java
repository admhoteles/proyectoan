...
//hay busqueda
      ...
      out.write("            <td>");
      out.print(reserva2.getId());
      out.write("</td>\r\n");
      out.write("            ");
Cliente  creservado=c.ListarClientePorid(reserva2.getId_cliente());
      out.write("\r\n");
      out.write("             <td>");
      out.print(creservado.getNombre());
      out.write("</td>\r\n");
      out.write("            <td>");
      out.print(reserva2.getId_hab());
      out.write(" </td>\r\n");
      out.write("            <td>");
      out.print(sdf.format(reserva2.getFechainicio().getTime()));
      out.write("</td>\r\n");
      out.write("               <td>");
      out.print(sdf.format(reserva2.getFechafin().getTime()));
      out.write("</td>\r\n");
      out.write("               <input type=\"hidden\" name=\"genreservaid\" value=\"");
      out.print(reserva2.getId());
      out.write("\">\r\n");
      out.write("              \r\n");
      ...
      out.write("\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\r\n");
      out.write("        <p>opps ese cuarto no esta en reserva</p>\t\r\n");
      out.write("        \r\n");
      out.write("        ");
