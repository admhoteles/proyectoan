<%-- 
    ...
    Author     : EDINSON
--%>
<%@page import="dto.principal"%>
<%@page import="dao.principaldao"%>
...
<body>
	...
	<section class="hero">
		<header id="main-header">
			<div class="wrapper">
				<a href="#"><img src="prin/img/logo.png" class="logo" alt="" titl=""/></a>
 ...
 <jsp:useBean id="consul" class="dao.principaldao" scope="session"></jsp:useBean>
    <%
   
      
    
   String m= consul.consultardatos();
	...
	<section class="listings">
		<div class="wrapper">
			<ul class="properties_list">
				<li>
					<a href="#">
						<img src="prin/img/property_1.jpg" alt="" title="" class="property_img"/>
					</a>
				...
				<li>
					<a href="#">
						<img src="prin/img/property_2.jpg" alt="" title="" class="property_img"/>
					</a>
				...
				<li>
					<a href="#">
						<img src="prin/img/property_3.jpg" alt="" title="" class="property_img"/>
					</a>
